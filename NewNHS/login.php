...
$res = mysql_query($sql);
$sql1 = "SELECT student_id FROM members WHERE username = '$id' and password='$password'";
$sql2 = "SELECT first_name FROM members WHERE username = '$id' and password='$password'";
$sql3 = "SELECT last_name FROM members WHERE username = '$id' and password='$password'";
$sql4 = "SELECT admin FROM members WHERE username = '$id' and password='$password'";
