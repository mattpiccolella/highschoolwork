...
?>
	...
	<div id="maincontent">
		<h3 style='padding:5px'>NHS Officers 2012-2013</h3>
		<p style='padding:5px'> President: Matthew Piccolella </p>
		<p style='padding:5px'> Vice President: Nick Fecci </p>
		<p style='padding:5px'> Treasurer: Allison Moran </p>
		<p style='padding:5px'> Secretary: RJ Curcio </p>
	</div>
</div>
<div id="footer">
